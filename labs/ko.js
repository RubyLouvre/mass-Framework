    ...
    !function(factory) {
        ...
        ko.utils = new (function () {
            ...
            return {
                ...
                toggleDomNodeCssClass: function (node, className, shouldHaveClass) {
                    ...
                    var hasClass = ko.utils.arrayIndexOf(currentClassNames, className) >= 0;//原className是否有这东西
        ...
        ko.jsonExpressionRewriting = (function () {
            ...
            return {
                ...
                //modelValue, allBindingsAccessor, 'value', elementValue, /* checkIfDifferent: */ true
                            ...
                            if (initPhase === 0) {
                                ...
                                for (var bindingKey in parsedBindings) {
                                    ...
                                    if (binding && typeof binding["init"] == "function") {
                                        ...
                                        if (initResult && initResult['controlsDescendantBindings']) {//这里主要是html,与template命令
        ...
        ko.bindingHandlers['value'] = {
            'init': function (element, valueAccessor, allBindingsAccessor) {
                ...
                var requestedEventsToCatch = allBindingsAccessor()["valueUpdate"];//change，keyup，keypress，afterkeydown
                if (requestedEventsToCatch) {
                    if (typeof requestedEventsToCatch == "string") // Allow both individual event names, and arrays of event names
                        requestedEventsToCatch = [requestedEventsToCatch]; 
                    ko.utils.arrayPushAll(eventsToCatch, requestedEventsToCatch);//合并
                    eventsToCatch = ko.utils.arrayGetDistinctValues(eventsToCatch);//去重
                }
        ...
        ko.bindingHandlers['with'] = {
            makeTemplateValueAccessor: function(valueAccessor) {
                return function() {
                    var value = valueAccessor(); return {
                        'if': value,
                        'data': value,
