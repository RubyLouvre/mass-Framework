                    ...
                    try {
                        ...
                        if (abort || completed) {  //由于respond在onreadystatechange会触发两次以上，因此必须
                            ...
                            if (abort) {
                                ...
                                if (nativeXHR.responseType && typeof nativeXHR.response !== "undefined") {
...
//                transport: null,
        ...
        dispatch: function(status, statusText) {
            ...
            this.fire(eventType, this.response, statusText);
            this.fire("complete", this.response, statusText);
