(function(global,DOC){
    ...
    dom.log("已加载node模块");
    dom.define("more/node_wrap",'node',function(){
        dom.implement({
            /**
             *用一个标签包裹所有匹配节点
             */
            wrapAll: function( html ) {
                if ( this[0] ) {
                    var wrap = dom( html, this.ownerDocument ).beforeTo( this[0] );
            ...
            unwrap: function() {
                return this.map(function(el){
                    ...
                    if(this.parentNode && this.parentNode.nodeType == 1 && this.tagName !== "BODY" ){
                        dom(this,this.ownerDocument).replace(this.childNodes );
                    }
                });
            },
            /**
            ...
            wrap : function( html ) {
                return this.each(function() {
                    dom( this,this.ownerDocument ).wrapAll( html );
                });
            },
            ...
            wrapInner :function(html){
                return this.each(function() {
                    ...
                    if ( contents.length ) {
                        dom(contents,this.ownerDocument).wrapAll( html );
                    } else {
                        dom(this,this.ownerDocument ).append( html );
                    }
                });
            }
        });
